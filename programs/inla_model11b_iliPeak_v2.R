...
## Name: Elizabeth Lee
## Date: 11/15/17
## Function: Model 11b v1: county iid model, peak ILI intensity response variable aggregation error
## Filenames: 
...
#### FILEPATHS #################################
file_dataImport <- paste0(getwd(), "/../R_export/inlaModelData_import/inlaImport_model11b_iliPeak_irDt_v7.csv")
