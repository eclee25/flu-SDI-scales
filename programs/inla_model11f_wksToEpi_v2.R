...
## Name: Elizabeth Lee
## Date: 11/15/17
## Function: Model 11f v2: county neighbor spatial model, aggregation error for weeks to epidemic start (from wknum 40) response variable
...
#### FILEPATHS #################################
file_dataImport <- paste0(getwd(), "/../R_export/inlaModelData_import/inlaImport_model11f_wksToEpi_irDt_v7.csv")
...
formula <- Y ~ -1 +
  intercept_nonzero + X_anomHumidity_nonzero
