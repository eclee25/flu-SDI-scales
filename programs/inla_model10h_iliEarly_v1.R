...
## Name: Elizabeth Lee
## Date: 5/28/18
## Function: Model 10b v1: state-level iid model, peak epidemic intensity response variable, with interaction terms, irDt version
## Filenames: physicianCoverage_IMSHealth_state.csv, dbMetrics_periodicReg_irDt_Octfit_span0.4_degree2_analyzeDB_st.csv
...
for (i in 1:length(modCodeLs)){
  ...
  modData_full <- model10h_iliEarly_irDt_v2(path_list)
