...
## Name: Elizabeth Lee
## Date: 4/3/17
## Function: Model 11a v1: aggregation bias model (offset: state-level shift1 seasonal intensity), iid spatial model, shifted response variable (e.g., seasonal intensity 0 -> 1), with interaction terms
...
for (i in 1:length(modCodeLs)){
  ...
  modData_hurdle <- convert_aggBias_spatiotemporal(modData_full[1:100,])
