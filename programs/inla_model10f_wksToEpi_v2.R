...
for (i in 1:length(modCodeLs)){
  ...
  formula <- Y ~ -1 +
    ...
    X_priorImmunity_nonzero + X_humidity_nonzero + X_pollution_nonzero + X_latitude_nonzero + X_sourceLocDist_nonzero + X_singlePersonHH_nonzero 
