...
## Name: Elizabeth Lee
## Date: 9/19/17
## Function: Model 8b v1: county iid model, peak ILI intensity response variable
## Filenames: 
...
#### FILEPATHS #################################
file_dataImport <- paste0(getwd(), "/../R_export/inlaModelData_import/inlaImport_model8b_iliPeak_v7.csv")
