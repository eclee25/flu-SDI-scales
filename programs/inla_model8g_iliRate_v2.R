...
## Name: Elizabeth Lee
## Date: 7/6/17
## Function: Model 8g v2: CAR spatial model, shifted response variable (e.g., raw ILI per 10K population 0 -> 1), with interaction terms
...
for (i in 1:length(modCodeLs)){
  ...
  modData_full <- model8g_iliRate_v7(path_list) #%>% 
    # keep_randomCty(keep)
