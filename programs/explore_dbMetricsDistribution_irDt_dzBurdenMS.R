...
explore_dbMetricsDistribution_irDt <- function(span.var, degree.var, spatial){
  ...
  #### import data ####################################
  setwd('../R_export')
  dbMetrics.g <- read_csv(sprintf('dbMetrics_periodicReg_%sirDt%s%s%s%s_analyzeDB%s_dzBurdenMS.csv', code, code2, spatial$servToggle, spatial$ageToggle, code.str, spatial$stringabbr), col_types="icllcd") %>% filter(season!=1)
  # standardized data
  ...
  dir.create(sprintf('../graph_outputs/explore_dbMetricsDistribution_%sirDt%s%s%s%s%s_dzBurdenMS', code, code2, spatial$servToggle, spatial$ageToggle, code.str, spatial$stringabbr), showWarnings=FALSE)
  setwd(sprintf('../graph_outputs/explore_dbMetricsDistribution_%sirDt%s%s%s%s%s_dzBurdenMS', code, code2, spatial$servToggle, spatial$ageToggle, code.str, spatial$stringabbr))
  ...
  ggsave(sprintf("distr_ILITot_%sirDt%s%s%s_dzBurdenMS.png", code, code2, code.str, spatial$stringabbr), plt.distr.iliSum, width=w, height=h)
  ...
  ggsave(sprintf("distr_ILIexcessBL_%sirDt%s%s%s_dzBurdenMS.png", code, code2, code.str, spatial$stringabbr), plt.distr.ILIexcessBL, width=w, height=h)
  ...
  ggsave(sprintf("distr_ILIexcessThresh_%silinDt%s%s%s_dzBurdenMS.png", code, code2, code.str, spatial$stringabbr), plt.distr.ILIexcessThresh, width=w, height=h)
  ...
  ggsave(sprintf("distr_pkCount_%sirDt%s%s%s_dzBurdenMS.png", code, code2, code.str, spatial$stringabbr), plt.distr.pkCount, width=w, height=h)
  ...
  ggsave(sprintf("distr_epiDur_%sirDt%s%s%s_dzBurdenMS.png", code, code2, code.str, spatial$stringabbr), plt.distr.epiDur, width=w, height=h)
  ...
  ggsave(sprintf("distr_epiTime_%sirDt%s%s%s_dzBurdenMS.png", code, code2, code.str, spatial$stringabbr), plt.distr.epiTime, width=w, height=h)
  ...
  ggsave(sprintf("distr_pkTime_%sirDt%s%s%s_dzBurdenMS.png", code, code2, code.str, spatial$stringabbr), plt.distr.pkTime, width=w, height=h)
