...
## Name: Elizabeth Lee
## Date: 4/1/17
## Function: Model 8f v1: iid spatial model, weeks to epidemic start (from ISO weeknum 40) response variable, with interaction terms and no spatial dependence
