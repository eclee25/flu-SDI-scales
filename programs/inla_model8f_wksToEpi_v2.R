...
## Name: Elizabeth Lee
## Date: 4/1/17
## Function: Model 8f v2: county neighbor spatial model, weeks to epidemic start (from wknum 40) response variable, with interaction terms
...
formula <- Y ~ -1 +
  ...
  # X_humidity_nonzero + X_anomHumidity_nonzero + 
  X_pollution_nonzero + X_singlePersonHH_nonzero + X_latitude_nonzero 
