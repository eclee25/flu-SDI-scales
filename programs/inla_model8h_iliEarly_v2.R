...
## Name: Elizabeth Lee
## Date: 9/19/17
## Function: Model 8h v2: county neighbor spatial dependence model, early ILI intensity response variable
## Filenames: 
...
#### FILEPATHS #################################
file_dataImport <- paste0(getwd(), "/../R_export/inlaModelData_import/inlaImport_model8h_iliEarly_irDt_log2_v7.csv")
