...
#   degree.var <- 2
  ...
  write.csv(data5_write, file = sprintf('fullIndicFlu_periodicReg_%sirDt%s%s%s%s_analyzeDB%s.csv', code, code2, spatial$servToggle, spatial$ageToggle, code.str, spatial$stringabbr), row.names=FALSE)
  write.csv(data6_write, file = sprintf('fullIndicAll_periodicReg_%sirDt%s%s%s%s_analyzeDB%s.csv', code, code2, spatial$servToggle, spatial$ageToggle, code.str, spatial$stringabbr), row.names=FALSE)
