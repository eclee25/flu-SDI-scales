...
## Name: Elizabeth Lee
## Date: 5/28/18
## Function: Model 10a v1: state-level iid model, total epidemic intensity response variable, with interaction terms, irDt version
...
for (i in 1:length(modCodeLs)){
  ...
  modData_full <- model10a_iliSum_irDt_v2(path_list)
